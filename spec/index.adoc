...
[title]
= OGC® GeoPackage OWS Context Extension =
...
This draft OGC® Encoding Standard defines a GeoPackage Extension to encode OWS Context Documents within a GeoPackage.

== Keywords ==

ogcdoc, geopackage, sqlite, raster, vector, feature, attributes, data, storage, exchange, mobile, smartphone, tablet, context
...
include::1_context_sql.adoc[]

include::2_context_gpkg.adoc[]

include::3_context_gpkg_ws.adoc[]

include::4_context_annexes.adoc[]
