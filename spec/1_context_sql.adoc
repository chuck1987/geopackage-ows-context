...
[[owcr6]]
[caption=""]
.Requirement 6 - http://www.opengis.net/spec/owc/1.0/req/gpkg/code
====
...
|=======================================================================
|Code |Dependency 
|`features`      |http://www.opengis.net/doc/IS/geopackage/1.2/opt/features
|`tiles`      |http://www.opengis.net/doc/IS/geopackage/1.2/opt/tiles
|`attributes`      |http://www.opengis.net/doc/IS/geopackage/1.2/opt/attributes
|=======================================================================
